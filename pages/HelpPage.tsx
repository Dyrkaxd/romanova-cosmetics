...
import { 
    ...
    ArchiveBoxIcon, OrdersIcon, SettingsIcon, SearchIcon
...
const SharedHelpContent: FC = () => (
     <HelpSection title="Глобальний AI-пошук" icon={SearchIcon}>
        <p>У верхній частині екрану (хедері) розташований потужний інструмент пошуку, який використовує AI для розуміння ваших запитів.</p>
        <ul className="list-disc list-inside space-y-2 pl-2">
            <li><strong>Що можна шукати:</strong> Замовлення, клієнтів та товари.</li>
            <li><strong>Розумні запити:</strong> Ви можете використовувати не тільки ключові слова (напр., "крем"), але й запити природною мовою, такі як "останні замовлення для Олени" або "товари з низьким залишком".</li>
            <li><strong>Принцип роботи:</strong> Gemini аналізує ваш запит, визначає, що саме ви шукаєте, і знаходить найбільш релевантні результати в системі.</li>
        </ul>
    </HelpSection>
);
             ...
             <ul className="list-disc list-inside space-y-2 pl-2">
                <li><strong>Звіт про прибутки та збитки:</strong> Розраховує 4 основні метрики:
                    <ul className="list-disc list-inside space-y-2 pl-6 mt-2">
                        ...
                        <li><strong>Валовий прибуток:</strong> Дохід мінус собівартість проданих товарів (ціна салону). Показує прибутковість до врахування операційних витрат.</li>
                        <li><strong>Витрати:</strong> Сума всіх витрат, доданих на сторінці "Керування витратами".</li>
                        <li><strong>Чистий прибуток:</strong> Ваш фінальний заробіток (Валовий прибуток - Витрати).</li>
                    </ul>
                </li>
        ...
        <HelpSection title="Товари" icon={ProductsIcon}>
            <p>Централізоване керування всім асортиментом вашої продукції.</p>
             <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong>Імпорт з CSV:</strong> Масово додавайте та оновлюйте товари за допомогою CSV-файлу. Файл повинен містити стовпці: `name`, `group`, `retailPrice`, `salonPrice`, `exchangeRate`. Існуючі товари оновлюються за назвою, нові - створюються.</li>
        ...
        <HelpSection title="Склад" icon={ArchiveBoxIcon}>
            <p>Ця сторінка призначена для інвентаризації та контролю залишків товарів на складі.</p>
             <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong>Оновлення кількості:</strong> Просто введіть нове значення в поле поруч з товаром та натисніть "Зберегти" (або Enter) для оновлення даних.</li>
        ...
        <HelpSection title="Замовлення" icon={OrdersIcon}>
            <p>Повнофункціональний інструмент для обробки замовлень від створення до відправки.</p>
             <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong>Керування документами:</strong> Створюйте, друкуйте або копіюйте посилання на Рахунок-фактуру для кожного замовлення, щоб легко поділитися ним з клієнтом.</li>
            </ul>
        </HelpSection>
        ...
        <HelpSection title="Клієнти" icon={UsersIcon}>
             <p>Ведення клієнтської бази, аналіз та сегментація.</p>
              <ul className="list-disc list-inside space-y-2 pl-2">
                 ...
                 <li><strong>Історія замовлень:</strong> Переходьте на сторінку деталей клієнта, щоб переглянути повну історію його покупок та аналізувати його поведінку.</li>
        ...
        <HelpSection title="Налаштування" icon={SettingsIcon}>
            <p>Керування доступом та глобальними параметрами системи.</p>
             <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong>Керування курсом валют:</strong> Встановлюйте курс UAH/$ глобально для всіх товарів або індивідуально для кожної групи. Це автоматично перерахує роздрібні ціни та ціни салону в гривні для нових позицій у замовленнях.</li>
